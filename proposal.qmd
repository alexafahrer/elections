...
We have created a `README.md` file that explains the organization of our repository. We plan to house the files for the Shiny app in a folder, the data set in a folder, and everything else will be in the main workflow. 
